...
```sql
update applications set cover_url = 'https://docs.google.com/document/d/15Z45_v1mXNR-sAqoEkVZ9OelLI19FrWyaESJd2rprcw/edit'
 where job_id in (...);
```

Master letter: `https://docs.google.com/document/d/15Z45_v1mXNR-sAqoEkVZ9OelLI19FrWyaESJd2rprcw/edit`
